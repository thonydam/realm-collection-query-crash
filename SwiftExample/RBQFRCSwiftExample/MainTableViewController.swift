...
class TestObject2: Object {
  ...
  class func object(title: String) -> TestObject2 {
    ...
    override func viewDidLoad() {
        ...
        for index in 1...1000 {
            ...
            if (index < 10) {
                ...
                object.objects.append(TestObject2.object("Hello"))
            }
            else {
        ...
        let predicate = NSPredicate(format: "inTable = YES AND objects.@count > 0")
